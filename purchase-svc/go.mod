module github.com/Chengxufeng1994/go-saga-example/purchase-svc

go 1.22.1

replace github.com/Chengxufeng1994/go-saga-example/common => ../common

require (
	github.com/Chengxufeng1994/go-saga-example/common v0.0.0-00010101000000-000000000000
